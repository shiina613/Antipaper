...
_TERM_DICTIONARY: dict[str, str] = {
    ...
    "tờ trình": "Văn bản đề xuất nội dung để cấp có thẩm quyền xem xét và quyết định.",
    "đề án": "Tài liệu trình bày mục tiêu, giải pháp, nguồn lực và lộ trình thực hiện một chương trình.",
    "dự thảo": "Phiên bản văn bản đang được lấy ý kiến hoặc hoàn thiện trước khi ban hành.",
    ...
    "lộ trình": "Trình tự thời gian và các mốc triển khai nhiệm vụ hoặc chính sách.",
    ...
    "tự luận": "Dạng câu hỏi yêu cầu người làm trình bày lập luận và phân tích bằng văn viết.",
    "trắc nghiệm": "Dạng câu hỏi có các lựa chọn trả lời để kiểm tra phạm vi kiến thức.",
    "nghị luận xã hội": "Dạng bài phân tích và bàn luận về một vấn đề xã hội.",
    "kinh tế học vĩ mô": "Lĩnh vực nghiên cứu các biến số tổng thể của nền kinh tế.",
    "triết học": "Lĩnh vực nghiên cứu các nguyên lý chung về thế giới quan, nhận thức và phương pháp luận.",
    "lý luận nhà nước và pháp luật": "Lĩnh vực nghiên cứu bản chất, chức năng và quan hệ giữa nhà nước với pháp luật.",
    "tỷ trọng đánh giá": "Tỷ lệ đóng góp của một thành phần vào kết quả đánh giá chung.",
    "vận dụng": "Mức độ áp dụng kiến thức hoặc quy định vào tình huống cụ thể.",
