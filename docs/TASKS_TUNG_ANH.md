...
| TA-02 | Q&A tiếng Việt dựa trên retrieved chunks | 6 | H20 | Trả answer + citation IDs; câu ngoài phạm vi bị từ chối |
| TA-03 | Citation validator và renderer trang/mục/điều | 4 | H20 | Loại ID không tồn tại; map đúng excerpt và metadata nguồn |
...
- Nhận chunk schema và normalized fixture từ Tuấn.
- Thống nhất citation ID với Hậu trước H8.
